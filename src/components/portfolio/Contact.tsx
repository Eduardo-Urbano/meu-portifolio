    ...
    <section id="contact" className="relative py-32">
      <div className="container mx-auto px-6">
        <div className="mx-auto max-w-5xl rounded-3xl glass p-8 md:p-14 shadow-elegant relative overflow-hidden">
          <div className="absolute -top-20 -right-20 h-64 w-64 rounded-full bg-gradient-primary opacity-20 blur-3xl" aria-hidden="true"/>
          <div className="absolute -bottom-20 -left-20 h-64 w-64 rounded-full bg-accent opacity-20 blur-3xl" aria-hidden="true"/>
          ...
          <div className="grid lg:grid-cols-2 gap-12 relative items-center">
              ...
              <div className="mt-8 space-y-4 flex flex-row justify-between">
                <div className="flex flex-col gap-3">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    aria-label="Falar com Eduardo Urbano pelo WhatsApp"
                    className="flex items-center gap-3 text-sm text-muted-foreground hover:text-foreground transition-all hover:translate-x-1"
                  >
                    <span className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-foreground/5">
                      <svg
            ...
            <div className="space-y-4 mt-8">
              ...
              >
                ...
                <button
                  type="submit"
                  aria-label="Enviar mensagem pelo formulário de contato"
                ...
                >
                  {sent ? "Mensagem enviada ✓" : (
                    <>
                      Enviar mensagem
                      <Send size={16} aria-hidden="true" className="transition-transform group-hover:translate-x-1" />
                    </>
                  )}
                </button>
              </motion.form>
